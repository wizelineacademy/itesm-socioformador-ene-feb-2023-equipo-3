...
const FormComponent2: FC<FormComponent2Props> = ({}) => {
  ...
  return (
    <FormProvider {...methods}>
      ...
      <form
        onSubmit={methods.handleSubmit(handleCreateData)}
        ...
        <div className="grid grid-cols-9">
          <div className="-bg-orange-500 col-span-6 m-8 flex flex-col gap-8">
            ...
            <p className="text-base font-light text-gray-400">
              Fill out the following information to create your profile. If you
              changed your mind and want to create you profile with Linkedin,
              make sure to hit the button and start with the process.
            </p>
            <div className="flex items-center">
              ...
              <div>
                <PDFUploadButton onPDFClick={handlePDFAutofill} />
              </div>
            </div>
            <AboutForm></AboutForm>
