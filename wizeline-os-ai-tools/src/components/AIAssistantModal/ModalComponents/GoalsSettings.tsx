    ...
    <div className="flex flex-col">
      <div className="flex flex-col gap-2">
        ...
        <p className="font-light">
          In order to help you, we need to define the goals of your description.{" "}
        </p>
      </div>
      <div className="my-8">
        {goalsNames.map((name, index) => (
          <div className="flex flex-col">
            <ToggleButtons
              ...
              setOption={(event: any, option: any) =>
                handleOptionSelect(name as keyof Goals, option)
              }
            />
            {index === goalsNames.length - 1 ? (
              ""
            ) : (
      ...
      <div className="flex flex-col">
        <p className="font-light">
          The next step will be to answer some questions about your experience
          in order to create your costum description!
        </p>
      </div>
    </div>
  );
