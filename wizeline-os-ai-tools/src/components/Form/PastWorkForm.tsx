...
const PastWorkForm: FC<PastWorkFormProps> = ({}) => {
    ...
    return (
        <div className='flex flex-col gap-4'>
            ...
            <Input id='title' placeholder='Title' title='Title'></Input>
            <div className='grid grid-cols-2 gap-4'>
                <div>
                    <Input id='start_date' title='Start Date' placeholder='Start Date'></Input>
                </div>
                <div>
                    <Input id='finish_date' title='End Date' placeholder='End Date'></Input>
                </div>
            </div>
            <Textarea id='description' title='Description'></Textarea>
            <Input id='skills' title='Skills' placeholder='Skills' ></Input>
        </div>
    )
}
