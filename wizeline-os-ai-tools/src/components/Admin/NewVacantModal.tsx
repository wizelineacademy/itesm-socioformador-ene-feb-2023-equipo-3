...
const NewVacantModal: FC<NewVacantModalProps> = ({ open, handleClose, addNewVacant }) => {
    ...
    const getContent = () => (
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4'>
            ...
            <div>
                <label htmlFor="" className="mb-1 block text-sm font-medium text-gray-900"> Skill </label>
                <Controller
                    name='vacantSkills'
                    control={control}
                    defaultValue={[]}
