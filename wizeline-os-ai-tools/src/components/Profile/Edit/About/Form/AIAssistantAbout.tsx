...
const promptPt1 =
  "you are an expert in writing about me sections for the employees of a software development company, enrich the following description text: “";
const propmPt2 =
  "“ , the final text must be less than 500 characters, in a single paragraph, should be written in 3rd person, write only the text, do not add descriptions or opinions.";
