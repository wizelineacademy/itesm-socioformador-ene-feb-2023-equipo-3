    ...
    return (
        <div className= "relative overflow-x-auto shadow-xl">
            <table className="w-full text-left">
                <thead className="pl-20 bg-white border border-gray-200">
                    <tr>
                        <th scope="col" className= "px-6 text-base font-inter font-normal py-4">
                            Projects
                        </th>
                        <th scope="col"></th>
                    </tr> 
                ...
                <tbody>
                {data.map((project) => (
                    <tr key={project.id} className="bg-white border border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th className="py-4">
                            ...
                            <p className="font-inter text-base font-light">{project.company}</p>
                            <p className="font-inter text-sm font-normal text-[#878787]">{project.state}, {project.country}</p>
                        </th>
                    </tr>
                ))}
                </tbody>
