...
const NewProject: FC<NewProjectProps> = ({}) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="m-8 flex flex-col gap-8">
      <div className="flex flex-col gap-4">
        ...
        <div className="-bg-orange-600">
          ...
          <div className="mt-2 flex flex-col">
            {vacants.length ? (
              vacants.map((vacant) => (
                <div className="mb-4 grid grid-cols-12 rounded-md border p-2 px-4">
        ...
        <NewVacantModal
          ...
          addNewVacant={addNewVacant}
        ></NewVacantModal>
      </div>

      <div className="-bg-orange-500 rounded-sm border border-slate-300 p-2">
